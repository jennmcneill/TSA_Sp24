...
```{r}
Renewable_Energy <- select(Renewable_Energy_Raw, Total.Biomass.Energy.Production:Hydroelectric.Power.Consumption)
...
```{r}
ts_biomass_production <- ts(Renewable_Energy$Total.Biomass.Energy.Production)
ts_renewable_production <- ts(Renewable_Energy$Total.Renewable.Energy.Production)
ts_hydroelectric_consumption <- ts(Renewable_Energy$Hydroelectric.Power.Consumption)

ts_biomass_production
ts_renewable_production
ts_hydroelectric_consumption
```
