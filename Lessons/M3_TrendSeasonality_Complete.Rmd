...
#this test is telling us that we have a trend. p is less than .05 so we reject the null hypothesis that there is no trend. score is positive, so trend is increasing. the value of the score depends on the number of observations.
...
#not a strong correlation, but we know that the slope is small so we were not expecting a strong correlation anyways.
```
