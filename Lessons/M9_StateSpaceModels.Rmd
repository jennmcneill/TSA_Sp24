...
SS_seas_new <- StructTS(ts_price,
                    type="BSM",fixed=c(0.001,0.01,0.3,NA)) 
#bsm = basic structural model which can fit seasonal components and trends
#this function has convergence issues
#this is with me trying to figure out the constants myself
#changing the variance of the seasonal component will make the confidence interval change
checkresiduals(SS_seas)
